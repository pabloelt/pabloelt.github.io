...
summary: A risk-scoring model is developed for a neo bank company using machine learning algorithms to assess the profitability of new loan applicants. The model predicts the expected loss by analyzing the Probability of Default, Loss Given Default, and Exposure at Default.
tags:
  - Machine Learning
date: 2024-09-05
