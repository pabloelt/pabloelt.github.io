...
*Note: Documentation available on the [GitHub Repository](https://github.com/pabloelt/ecommerce-analysis-and-optimization) is currently in Spanish. It will be soon updated to English.*
{style="color: #aaaaaa"}
